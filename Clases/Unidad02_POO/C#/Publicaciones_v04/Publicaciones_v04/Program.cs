...
namespace Publicaciones_v04
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            publicaciones[2] = new Tesis("A systema of logic based on ordinals", "Alan Mathison Turing", 1938, Clase_de_Tesis.LICENCIATURA, "Departamento de Matemáticas", "Universidad de Princeton", "Princeton", "NJ");
