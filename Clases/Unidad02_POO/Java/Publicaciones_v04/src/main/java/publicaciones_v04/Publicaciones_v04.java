...
public class Publicaciones_v04 {
    public static void main(String[] args) {
        ...
        publicaciones[2] =  new Tesis("A systema of logic based on ordinals", new Autor("Turing", "Alan Mathison"), 1938, Clase_de_Tesis.DOCTORADO, "Departamento de Matemáticas", "Universidad de Princeton", "Princeton", "NJ");
